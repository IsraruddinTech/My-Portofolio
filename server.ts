...
// Setup Asset Serving / SPA fallback
if (process.env.NODE_ENV !== "production") {
  // Asynchronously load Vite and mount its middleware
  ...
  // API routes are registered first, so anything else falls back to index.html
  app.get("*", (req, res) => {
